...
function get_list_courier() {
	$kotakab = sanitize_text_field($_GET['kecamatan']);
	$nextnonce = sanitize_text_field($_GET['nextNonce']);
	...
	if(!empty($kotakab))
	{
		$li_kecamatan = get_list_of_courier($kotakab);		
	}
   ...
   add_action('wp_ajax_get_list_courier','get_list_courier');
   add_action('wp_ajax_nopriv_get_list_courier','get_list_courier');
?>
